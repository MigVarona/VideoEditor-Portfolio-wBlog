...
exports.createPost = async (req, res) => {
  try {
    ...
    const newPageContent = `
      ...
      <body>
        <div style="background-color: black;" class="navbar-transparent w-nav" data-collapse="medium" role="banner"
        data-no-scroll="1" data-duration="400" data-doc-height="1">
        <div class="gradient"></div>
        <div class="nav-container w-container">
          <a href="http://localhost:5502/index.html" class="brand w-nav-brand">
            <img src="http://localhost:5502/assets/flaticon home.png" loading="lazy" alt="logo" style="height: 80px !important;" />
          </a>
          <nav role="navigation" class="nav-menu w-nav-menu">
            <div class="tablet-menu"><a href="http://localhost:5502/index.html" class="brand-tablet w-nav-brand"><img
              ...
              <div class="close-menu-button w-nav-button"><img src="http://localhost:5502/assets/flaticon home.png" loading="lazy"
                  alt="icon" height="16" class="nav-close-icon" /></div>
            </div>
            <div class="menu-wrap">
                ...
                <div class="nav-dropdown-toggle w-dropdown-toggle">
                  <div class="clip">
                    <div class="btn-banner-text">
                      <a href="http://localhost:5502/about.html" style="color: white; text-decoration: none;">
                        <div class="btn-title-text">About Me <span class="tablet-hidden">+</span></div>
                      </a>
                    </div>
                    <div class="btn-banner-text button-text-bottom">
                      <div class="btn-title-text">About Me +</div>
                    </div>
                  </div>
                </div>
              </div>
              <div data-hover="true" data-delay="0" data-w-id="1bba802f-7b9e-f63d-4f08-053960cc377a"
                ...
                <div class="nav-dropdown-toggle w-dropdown-toggle">
                  ...
                  <div class="clip">
                    <div class="btn-banner-text">
                      <div style="color: white;" class="btn-title-text">Works <span class="tablet-hidden">+</span></div>
                    </div>
                    <div class="btn-banner-text button-text-bottom">
                      <div style="color: white;" class="btn-title-text">Works +</div>
                    </div>
                  </div>
                </div>
                <nav class="nav-dropdown-list w-dropdown-list">
                  <div class="nav-dropdown-link-wrapper"><a href="http://localhost:5502/education.html"
                      class="nav-dropdown-link w-dropdown-link"><span class="nav-dropdown-link-line"></span>Education</a>
                    <a href="http://localhost:5502/entertaiment.html" class="nav-dropdown-link w-dropdown-link"><span
                        class="nav-dropdown-link-line"></span>Entertaiment</a>
                    <a href="http://localhost:5502/corporate.html" class="nav-dropdown-link w-dropdown-link"><span
                        class="nav-dropdown-link-line"></span>Corporate</a>
                  </div>
                </nav>
              </div>
